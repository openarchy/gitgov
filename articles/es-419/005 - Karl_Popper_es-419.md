...
Un hombre de setenta años está de pie ante quinientos jueces. No está acusado de un crimen con víctimas. No robó, no mató, no conspiró. La acusación es otra: hace demasiadas preguntas. Corrompe a los jóvenes enseñándoles a cuestionar. Falta el respeto a los dioses de la ciudad al dudar de las certezas que todos fingen tener.
...
Dos mil trescientos años después, un joven austríaco de familia judía leyó la historia de Sócrates en una Viena que empezaba a arder. Estaba viendo en vivo el mismo mecanismo: sociedades que castigan la duda. Que eligen certezas absolutas y matan a quienes disienten, a veces literalmente.

Ese joven se llamaba Karl Popper.

Sócrates pagó con su vida por hacer demasiadas preguntas. Popper pasó toda su vida intentando entender por qué las sociedades hacen eso y cómo construir sistemas que no lo hagan.

La respuesta que encontró es la idea central de este artículo.

**¿Por qué Popper empieza aquí?**

Sócrates no era ingenuo. Sabía que la duda incomoda. Que quien cuestiona amenaza a quienes tienen interés en mantener las respuestas listas. El método socrático —nombre dado a su forma de hacer preguntas hasta revelar contradicciones— no es una técnica de debate. Es una arquitectura de descubrimiento: no llegás a la verdad por proclamación, llegás por eliminación del error.

Popper tomó esa intuición y la convirtió en sistema. Si Sócrates mostró que las certezas de los demás eran falsas, Popper preguntó: ¿cómo construir un mundo donde la falsedad pueda descubrirse y corregirse sin que quien la descubre sea asesinado?
...
Al otro lado del globo, Europa ardía. Campos de exterminio funcionando a escala industrial. Popper seguía todo por la radio, con meses de retraso, y dos preguntas lo carcomían: ¿cómo ocurrió el nazismo? ¿Cómo impedir que vuelva a ocurrir?
...
Hegel argumentó que la Historia (con mayúscula) se mueve hacia una meta predeterminada y que el Estado es la encarnación de ese destino. Popper tradujo: quien detenta el poder puede afirmar que representa el futuro inevitable, y cualquiera que se oponga está oponiéndose a la Historia misma.

Marx dijo que la lucha de clases llevaría inevitablemente a un estado obrero, después del cual la historia terminaría. Popper tradujo: una teoría que no puede ser falsificada. Todo la confirma, nada la refuta. Por su propio criterio, no es ciencia, es religión.

Los tres comparten una estructura común: certeza sobre hacia dónde va la historia, concentración del poder arriba, y eliminación sistemática del mecanismo de corrección. Ellos lo llaman ideología. Popper lo llamó arquitectura de los desastres.

### **La ingeniería social gradual.**

La alternativa de Popper no era construir utopías. Era algo modesto e incómodo: ingeniería social gradual. En vez de planificar la sociedad perfecta e imponerla por la fuerza, hacés cambios pequeños, observás qué pasa, corregís lo que salió mal y seguís. Cada cambio es reversible. Ninguna apuesta requiere quemar todo antes de empezar.

Popper no estaba en contra del cambio. Estaba en contra de cambios irreversibles basados en certezas absolutas.
...
Una objeción aparece aquí con frecuencia: el falibilismo es una idea científica. ¿Qué tiene que ver con una reunión de directorio, una asamblea de cooperativa, una decisión del concejo municipal? La respuesta está en el patrón, no en el vocabulario. Todo grupo que toma decisiones sin un mecanismo estructurado de crítica está repitiendo el error de Platón: asumir que quien decide sabe más y por lo tanto no necesita ser cuestionado. El criterio cambia. El riesgo es el mismo.

**El falibilismo es una confirmación (commit).** La confirmación —el registro de un cambio en el sistema— parte del principio de que toda decisión es provisional. Registrás lo que hiciste, con fecha, autor y motivo. No porque sea perfecto. Porque necesita ser rastreable para cuando descubrás que estabas equivocado.
...
**La paradoja de la tolerancia es la protección del repositorio.** Si cualquier persona puede fusionar directamente sin revisión, alguien inyectará código malicioso. La apertura total sin protección se destruye a sí misma. Por eso existe la revisión obligatoria.
...
Kelsey resistió durante 19 meses las presiones de la industria y de sus superiores. Mientras tanto, más de 10.000 niños nacían con malformaciones en Europa. En los Estados Unidos, el número se mantuvo por debajo de 20. El sistema tenía, en ese caso, un mecanismo popperiano: la aprobación exigía que el solicitante demostrara seguridad de forma verificable, no que simplemente la declarara. En 1962, Kelsey recibió la más alta condecoración civil estadounidense. Popper habría dicho que el sistema no funcionó porque Kelsey era más inteligente. Funcionó porque el criterio era más riguroso: la carga de la prueba recaía sobre quien afirmaba, no sobre quien dudaba.

Un ejemplo ilustrativo: una cooperativa agrícola del interior decide, por votación, aceptar un nuevo proveedor. Seis meses después, el proveedor se atrasa en todo, gran perjuicio, y nadie sabe quién lo propuso, quién argumentó a favor, cuáles fueron los términos. Consenso sin registro es la sociedad cerrada de Popper en miniatura.
...
Quien afirma tener certeza absoluta te está pidiendo que dejes de pensar.

Probá poco, observá, corregí, repetí. La revolución total es una apuesta con el dinero de los demás.

La apertura sin protección se destruye. Todo sistema abierto necesita reglas contra quienes quieren cerrarlo.
...
Popper dio el paso siguiente: el consentimiento no alcanza. ¿Y si la mayoría vota a favor de la catástrofe? El valor de un sistema no es tener razón. Es poder corregirse.

Locke dijo de dónde viene la autoridad: de abajo hacia arriba. Popper dijo qué hacer cuando la autoridad se equivoca: corregir rápido, sin violencia, con registro.
