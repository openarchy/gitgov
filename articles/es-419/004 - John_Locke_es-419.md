...
¿Alguna vez participaste en una decisión que no podía deshacerse? ¿Una asamblea que aprobó algo por mayoría, pero sin ningún mecanismo para corregirlo si salía mal? ¿Una directiva que cambió las reglas a mitad del juego y nadie sabía cómo contestarlo?
...
Durante años, gobernó como monarca absoluto. Ignoró al Parlamento. Persiguió a los protestantes. Nombró aliados en puestos de poder. Cuando la gente se quejaba, la respuesta era silencio o espada.

Guillermo de Orange, holandés casado con la propia hija de Jacobo, cruzó el canal con un ejército. No necesitó pelear. El rey huyó en la madrugada, arrojando el Gran Sello de Inglaterra al río Támesis (como si borrar el sello borrara el fracaso). Los historiadores llaman a esto la Revolución Gloriosa: un cambio de gobierno casi sin sangre.

Pero quedó un vacío en el aire. Filosófico, del tamaño de un continente.

Si los reyes gobiernan porque Dios los eligió (eso era lo que todo el mundo creía), ¿por qué Dios dejó que expulsaran a este? Y si el nuevo rey también fue elegido por Dios, ¿por qué necesitó un ejército?
...
¿Qué harían las personas racionales? Un acuerdo. Cada una cede parte de su libertad (como hacerse justicia por mano propia) a cambio de seguridad colectiva (un gobierno que protege, arbitra, castiga). Locke llamó a esto el contrato social.

El contrato no es un documento real. Nadie lo firmó. Es un acuerdo implícito: ¿aceptás vivir en una sociedad con gobierno? Entonces estás acordando las reglas.
...
Antes de Locke, la propiedad venía de la conquista (matás a alguien y te quedás con la tierra), la herencia (tu abuelo era noble) o el regalo del rey. Locke lo invirtió: la propiedad viene del trabajo.

Imaginá un bosque sin dueño. Entrás, cortás madera, construís una casa. La casa es tuya. ¿Por qué? Porque mezclaste tu esfuerzo con la materia bruta. Plantás, cosechás, transformás. El producto es tuyo.

En 1689, eso era dinamita. Significaba que un campesino que trabajaba la tierra tenía más derecho a ella que un noble perezoso que heredó un título. Significaba que el trabajo genera legitimidad, no la sangre ni el decreto.

Esta idea tiene un eco directo en el código abierto: tu contribución (confirmación/COMMIT) es tuya. Nadie puede borrar tu nombre del historial. El mérito se prueba por lo que hiciste, no por el cargo que ocupás.

### **Dividir para no corromperse**

Locke notó un patrón: quien concentra poder, abusa. Siempre. No necesariamente por maldad, sino porque la tentación es demasiado grande.

La solución: dividir. Locke propuso separar a quienes hacen las leyes (Legislativo) de quienes las ejecutan (Ejecutivo) de quienes manejan las relaciones externas (Federativo). Nadie puede ser juez en su propia causa. Si el rey hace las leyes, las ejecuta y juzga a quienes las incumplen, es tirano por definición.
...
Antes de los paralelos: una objeción legítima. Esto funciona en software, donde las reglas son código y el historial es automático. La gobernanza está hecha de personas, política, intereses. ¿Cómo resuelve esto un sistema pensado para archivos de texto?

La respuesta está en el mecanismo, no en el medio. Lo que Git hace con archivos, los 21 Pasos lo hacen con decisiones: registran quién propuso, cuándo, con qué justificación. Hacen visible el historial. Permiten deshacer. La tecnología cambia. El principio es el mismo que Locke describió en 1689.

**La rebelión es reversión (REVERT).** Locke dijo: si el gobierno rompe el contrato, el pueblo puede deshacerlo. No es caos, no es anarquía. Es un mecanismo legítimo de corrección. En Git, la reversión/REVERT (Paso 15) hace exactamente eso: deshace una decisión específica que salió mal, sin destruir el historial. Locke inventó la reversión política 316 años antes de que Torvalds inventara la reversión técnica. Este artículo tiene el nombre que tiene por esa razón.

**Paso 15 — Reversión (REVERT):** Locke dijo que el poder sin mecanismo para deshacer es tiranía. En el sistema de los 21 Pasos, la reversión es ese mecanismo: deshacés una decisión específica sin borrar el historial de lo que pasó. El consentimiento no es definitivo; es continuo. Cuando el acuerdo falla, hay forma de volver atrás. La legitimidad se reconstruye por el proceso, no por decreto.

**El consentimiento es opt-in, no imposición.** En Git, nadie está obligado a aceptar una fusión (MERGE). En el contrato social de Locke, nadie está obligado a aceptar un gobierno que no lo representa. El consentimiento es la base: sin él, el sistema es ilegítimo. En el versionamiento, esto aparece en los Pasos 1 a 4 (las cuatro libertades): ver, participar, adaptar, compartir. Si cualquiera de ellas está bloqueada, no hay consentimiento real.

**La separación de poderes es revisión (REVIEW) obligatoria.** Locke dijo: nadie se juzga a sí mismo. En el versionamiento, el Paso 12 dice lo mismo: toda decisión requiere que alguien más revise antes de que sea aceptada. Nadie aprueba su propio trabajo. El principio es idéntico: la concentración de poder corrompe; la revisión distribuye.

**La propiedad por el trabajo es autoría por confirmación (COMMIT).** Locke dijo: lo que produjiste con tu esfuerzo es tuyo. En Git, cada confirmación/COMMIT registra el autor, la fecha, el motivo. Tu contribución queda inscrita. El mérito se prueba por el historial público, no por título o nombramiento.
...
Lo que los barones inventaron en 1215 es el mecanismo que Locke describiría 474 años después en lenguaje filosófico: el poder tiene condiciones. Si las condiciones se rompen, el acuerdo puede deshacerse. El rey Juan firmó, ignoró el documento, los barones reaccionaron, y la Magna Carta tuvo que ser reemitida varias veces hasta convertirse en norma permanente. El historial quedó registrado. La posibilidad de revertir el poder arbitrario pasó a existir como principio, no solo como rebelión. La primera reversión política documentada de la historia occidental ocurrió en el campo de Runnymede, en una tarde de junio, 474 años antes de que Locke escribiera la teoría que la sustenta.

Imaginá ahora una asociación de vecinos que decide todo en reunión presencial, los martes, a las 19 horas. Quien trabaja de noche nunca participa. Quien vive lejos, igual. Las decisiones las toman quienes aparecen, no quienes se ven afectados.
...
Ninguna autoridad es legítima por decreto. La legitimidad se construye y se mantiene mediante la rendición de cuentas.

Separar a quienes deciden de quienes ejecutan de quienes supervisan no es burocracia: es protección contra el abuso.

La propiedad (o la autoría) viene del trabajo visible, no del cargo o el título. Un historial público habla más fuerte que cualquier credencial.
...
Pero Locke dejó una brecha enorme.

¿Y si el pueblo consiente en algo pésimo? ¿Y si la mayoría, de manera libre y espontánea, aprueba una ley desastrosa? ¿Y si el sistema basado en el consentimiento produce resultados terribles?
