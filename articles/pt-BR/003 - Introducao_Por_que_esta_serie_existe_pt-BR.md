...
Neste exato momento, enquanto você lê estas palavras, algo invisível sustenta quase tudo que você faz. Seu celular funciona porque existe um sistema operacional chamado Linux rodando nos servidores que entregam suas mensagens, seus vídeos, seus pagamentos. Linux é um programa de computador criado por voluntários do mundo inteiro, sem dono, sem empresa por trás, sem chefe. Qualquer pessoa pode ver como ele funciona por dentro, modificar o que quiser, distribuir sua versão. Isso se chama código aberto (ou software livre): programa que não tem cadeado.

O Linux roda em 90% dos servidores da internet. Roda nos smartphones Android. Nos supercomputadores da NASA. Nos seus sites mais acessados: redes sociais, bancos, gerenciadores de e-mail, streamings. Nas bolsas de valores. Nos sistemas de navegação de aviões. É a maior colaboração voluntária da história humana.

E quase ninguém sabe que existe.

O modo como milhares de programadores trabalham juntos nesse software sem nunca terem se conhecido usa uma ferramenta chamada Git: um sistema que registra cada mudança feita por cada pessoa, com data, autor e motivo. Se alguém erra, o erro pode ser desfeito sem destruir o resto. Se alguém discorda do rumo, pode fazer uma cópia e seguir caminho próprio. Tudo aberto. Tudo rastreável. Tudo reversível.

Pois existe algo ainda mais invisível que o Linux e o Git. E muito mais urgente.
...
Há uma tradição antiga de traduzir ideias complicadas em linguagem que qualquer pessoa entende. Voltaire usou contos para criticar poder e superstição. Montesquieu fingiu ser um persa visitando a França para revelar absurdos que os franceses não enxergavam. Heródoto contava histórias de povos distantes para ensinar sobre o seu próprio.

Esta série quer fazer algo parecido: traduzir complexidade.

A tese é direta. Polarização, corrupção, fake news, representatividade baixa, tráfico de interesses, má gestão beirando a incompetência, leis que ninguém entende e até mesmo lawfare (uso estratégico e abusivo do sistema jurídico como arma política, simulando legalidade): tudo isso são sintomas. O problema é de arquitetura. Estrutural. Como a fundação de uma casa: se a base está torta, não adianta trocar a pintura ou as maçanetas. Precisa mexer no alicerce.

Para entender qualquer coisa com profundidade, ajuda saber de onde veio. Quem acordou no meio de uma estrada sem saber de onde saiu pode seguir qualquer direção, mas quase nenhuma será a certa. Sem trajetória, não há orientação. Esta série segue uma lógica histórica e cronológica por isso: primeiro, o contexto em que cada ideia nasceu. Depois, como ela evoluiu, o que foi corrigido, o que sobreviveu ao teste do tempo. O método que organiza isso tem nome: LATCH, proposto por Richard Saul Wurman. Cinco formas de estruturar qualquer informação: Local, Alfabeto, Tempo, Categoria, Hierarquia. Esta série usa tempo para revelar causalidade, hierarquia para mostrar quem influenciou quem, e categoria para revelar padrões que só aparecem quando você compara ideias de séculos diferentes. Não é decoração metodológica. É o que permite enxergar estruturas invisíveis num conjunto de 335 anos de pensamento.
...
Stallman ficou furioso. Não era pela impressora. Era pelo princípio: alguém em um escritório distante decidiu que ele não podia consertar sua própria ferramenta de trabalho. Alguém colocou cadeado no conhecimento.

Em 1983, lançou o Projeto GNU. Em 1985, fundou a Free Software Foundation e escreveu a GPL (General Public License, licença pública geral): a primeira licença que garantia por lei quatro liberdades. Usar o programa para qualquer fim. Estudar como funciona e modificá-lo. Redistribuir cópias. Distribuir versões modificadas.

Stallman não inventou tecnologia. Inventou ética para tecnologia. Disse: conhecimento não deve ter cadeado.
...
Em poucos anos, Linux se tornou o sistema operacional mais confiável do planeta. Torvalds provou que não é preciso ter corporação bilionária, exército de gerentes e contratos de sigilo para criar algo extraordinário. Basta gente motivada, regras claras e abertura total.
...
Torvalds ficou furioso. De novo. E de novo, em vez de reclamar, agiu. Em dez dias, criou o Git: um sistema para gerenciar versões de código que era distribuído (ninguém controlava sozinho), rápido e totalmente aberto.
...
Três homens. Três frustrações. Três respostas que mudaram o mundo sem pedir licença a ninguém.

Stallman enfrentou uma impressora trancada e criou uma filosofia de liberdade. Torvalds enfrentou acesso negado duas vezes (à universidade e ao BitKeeper) e criou Linux e Git. Raymond observou o caos organizado e explicou por que funcionava melhor que a ordem planejada.

O padrão é sempre o mesmo: alguém tenta trancar o conhecimento. A resposta não é implorar acesso. É construir algo aberto que ninguém possa trancar de novo.
...
Se milhares de voluntários criam software mais confiável que corporações bilionárias, por que cidadãos não podem criar regras melhores que políticos profissionais?

Se Git permite rastrear cada mudança, cada decisão, cada erro, com total transparência, por que nossas organizações não usam esse princípio?

Se código aberto provou que abertura não é fraqueza (é mecanismo de correção), por que continuamos aceitando que decisões coletivas sejam tomadas a portas fechadas?
