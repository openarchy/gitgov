...
Ele tinha fugido de Viena em 1934, quatro anos antes de os nazistas anexarem a Áustria. Foi para Genebra, depois para Nova York, com 58 anos, sem emprego fixo, sem dominar o inglês. A Universidade de Nova York lhe ofereceu um cargo não remunerado. Quem pagava era uma fundação privada. Seus colegas o toleravam. O establishment o ignorava.

Human Action vendeu pouco. As resenhas foram frias.

Ele morreu em 1973, aos 92 anos, convicto de que havia fracassado.
...
Mises chamou isso de ordem espontânea. Não é anarquia. Não é bagunça. É coordenação que nasce da ação de milhões de indivíduos, cada um perseguindo seus próprios objetivos com suas próprias informações, sem que ninguém tenha desenhado o conjunto.

O preço do tomate na feira é ordem espontânea. Nenhum ministro decidiu que custaria quatro reais. O preço emerge da interação entre quem planta, quem transporta e quem compra. Cada um sabe coisas que os outros não sabem. O preço agrega tudo em um único número.
...
Essa base permite algo poderoso: se toda ação envolve escolha, observar o que as pessoas fazem revela o que valorizam. Não o que dizem valorizar: o que fazem. Mises chamou isso de preferência demonstrada. O político que diz defender austeridade e vota aumento para si mesmo demonstrou sua preferência real. O número de issues abertas num repositório demonstra o que os participantes consideram problema. Palavras informam intenção. Ações informam verdade.

### **O termômetro que nenhum planejador substitui.**

Se a ordem emerge de ações individuais, como as pessoas se coordenam sem se falar? Pelos preços. Mises via preços como sinais que carregam informação comprimida sobre o mundo. Quando o preço do aço sobe, a mensagem é: aço ficou mais escasso, use menos ou procure alternativa. Ninguém precisa saber por quê. O sinal basta.
...
Mises nunca viu um computador. Morreu dezoito anos antes de Torvalds criar o Linux. Mas seus conceitos descrevem com precisão cirúrgica o que acontece num repositório aberto.

Uma objeção aparece aqui com frequência: ordem espontânea funciona no mercado, onde cada um age por interesse próprio. Mas uma cooperativa, um conselho, uma associação têm regras, hierarquia e responsabilidade. Não posso deixar tudo emergir sozinho. A resposta de Mises seria direta: você não deixa tudo emergir sem regras. Você projeta regras simples e deixa o resultado emergir do processo. A diferença entre um comitê que decide o que todos precisam e um sistema que agrega o que cada um informa não é ausência de estrutura. É onde a estrutura atua: no processo, não no resultado.

O Linux é ordem espontânea digital. Ninguém planejou o resultado. Milhares de pessoas, cada uma com suas habilidades e seu tempo, contribuíram com o que sabiam. O resultado é mais sofisticado do que qualquer empresa conseguiria projetar. Não tem CEO. Tem processo.

**Passo 7 — MAIN:** no sistema dos 21 Passos, MAIN é a branch (o ramo, a versão) oficial, o documento onde ficam as decisões validadas pelo grupo. A intuição errada é imaginar que alguém decretou o que entra no MAIN. A intuição correta, a de Mises, é que o MAIN emerge do processo: é o resultado acumulado de todas as contribuições que passaram por review e foram aceitas. Ninguém desenhou o MAIN. Ele é o que sobrou depois que o processo de seleção distribuída funcionou. Ordem espontânea com regras claras de entrada.
...
Em 1974, dois engenheiros americanos, Vint Cerf e Bob Kahn, publicaram um artigo técnico descrevendo um protocolo de comunicação entre computadores. A ideia central era radical: nenhum computador central controlaria o tráfego. Cada pacote de dados encontraria seu próprio caminho pela rede, escolhendo rotas disponíveis em tempo real. Ninguém planejava, ninguém coordenava, ninguém sabia de antemão por onde a informação passaria.
...
Este é o quarto artigo do núcleo. Locke estabeleceu de onde vem a autoridade: do consentimento. Popper mostrou que o valor de um sistema não é acertar, mas corrigir. Hayek provou que nenhum cérebro central tem informação suficiente para decidir por todos. Mises completou a base: se ninguém controla tudo, a ordem surge das ações de quem participa. Sem planejador. Sem chefe. Sem votação.

Quatro peças encaixadas. Mas falta uma pergunta que nenhum dos quatro respondeu: o que é, exatamente, a informação que flui nesses sistemas?

Hayek disse que preços carregam informação. Mises disse que ações revelam preferências. Mas ninguém definiu informação como conceito preciso, medível, com fórmula.

Em 1948, um engenheiro dos Laboratórios Bell publicou 55 páginas que mudaram o mundo sem que o mundo percebesse. Claude Shannon fez algo que parece impossível: mediu informação. Deu a ela uma unidade (o bit), uma fórmula e uma definição que derruba séculos de confusão: informação não é o que você sabe. É o que reduz sua incerteza.
